...
var btoa = (typeof window !== 'undefined' && window.btoa) || btoa_1;
...
var streamConsume = function(stream) {
...
var debug = browser('follow-redirects');



var create = function(_nativeProtocols) {
  var nativeProtocols = {};
  ...
  function execute(options) {
    ...
    function cb(res) {
      ...
      if (res) {
        ...
        extend$1(options, url.parse(redirectUrl));
      }
...
var axios$2 = createInstance();

// Expose Axios class to allow class inheritance
axios$2.Axios = Axios_1;

// Factory for creating new instances
axios$2.create = function create(defaultConfig) {
 ...
 * @return {Promise}
 */
var fetchInclude = memoize(function (document) {
 ...
 * @return {ShadowDOM}
 */
var withContext = function withContext(contextTypes) {
  var _class2, _temp3;
  ...
  return _temp3 = _class2 = function (_Component) {
    ...
    _createClass(ShadowDOM, [{
      ...
      value: function wrapContainer() {
        ...
        var child = children.length ? React.createElement(
          this.props.nodeName,
          null,
          children
        ) : children;
      ...
      value: function attachIncludes(include) {
        ...
        var groupedFiles = groupBy(function (file) {
          return file.extension;
        })(include.map(function (filePath) {
          return { filePath: filePath, extension: filePath.split('.').pop() };
        }));
      ...
      value: function render$$1() {
        ...
        return this.validate() && function () {
          ...
          var child = Children.only(_this6.props.children);
          var childProps = dissoc('children', child.props);
    ...
    return ShadowDOM;
  }(Component), _class2.contextTypes = contextTypes, _class2.propTypes = {
    children: propTypes.node.isRequired,
...
var reactShadow = withContext(defaultContextTypes);
